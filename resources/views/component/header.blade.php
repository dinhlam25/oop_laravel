                        ...
                        <div class="section" id="logo" name="Logo ảnh">
                            <div class="widget HTML" data-version="1" id="HTML19">
                                <div class="widget-content">
                                    <a class="logo-wrapper" href="/" title="Tech_Shop">
                                        <img
                                            alt="logo Tech_Shop"
                                ...
                                <div class="mega-content">
                                    <ul class="level0 col-md-9 no-padding">
                                        ...
                                        <li class="level1 parent item">
                                            <a class="hmega" href="/danh-muc/{{ $category->id }}-{{ Str::slug($category->name, '-') }}.html">
                                               {{$category->name}}
                                            </a>
                                            <ul class="level1">
                                                <li class="level2">
                                                         ...
                                                         @foreach($category->categoryChilden as $categoryChilden)
                                                             ...
                                                             <a href="/danh-muc/{{ $categoryChilden->id }}-{{ Str::slug($categoryChilden->name, '-') }}.html">{{$categoryChilden->name}}"</a>
                                                          @endforeach
