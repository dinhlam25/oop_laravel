                                                ...
                                                <div class="ant-single-product">
                                                    ...
                                                    <div class="ant-product-border">
                                                        <h3 class="product-title">
                                                            <a href="/san-pham/{{ $item->id }}-{{ Str::slug($item->name, '-') }}.html" title="">{{$item->name}}</a>

                                                        </h3>
                                                        <div class="product-price">
                                                            @if($item->price_sale != 0 )
                                                                <span class="price item_price">{{number_format($item->price_sale, 0, '', ',')}} VNĐ</span>
                                                                <span class="price-before-discount">{{number_format($item->price, 0, '', ',')}} VNĐ</span>
                                                            @else
                                                                <span class="price item_price">{{number_format($item->price, 0, '', ',')}} VNĐ</span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
